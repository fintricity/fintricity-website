    ...
    <article className="bg-white min-h-screen">
          ...
          <div className="max-w-4xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <div className="flex flex-wrap items-center gap-4 mb-8">
                <Badge variant="plum" className="bg-kendra-plum text-white uppercase tracking-wider font-bold border-transparent">
              ...
              <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-kendra-blue mb-8 leading-[1.1]">
                {content.title}
              </h1>
              ...
              {content.author && (
                <div className="flex items-center gap-3 mb-10 pb-10 border-b border-gray-100">
                  ...
                  <div>
                    <div className="text-sm font-bold text-kendra-blue">{content.author}</div>
               ...
               <div className="mt-20 pt-10 border-t border-gray-100">
                 ...
                 <div className="flex flex-wrap gap-3">
                   {content.tags.map((tag: string) => (
                     <Link key={tag} href={`/insights`} className="px-4 py-2 bg-gray-50 text-gray-600 rounded-full text-sm font-medium hover:bg-kendra-blue hover:text-white transition-colors">
                       #{tag}
                     </Link>
                   ))}
                 </div>
      ...
      <section className="py-24 bg-gray-50 border-t border-gray-200">
        <div className="container mx-auto px-4 text-center">
           <h2 className="text-3xl font-bold text-kendra-blue mb-10">Continue the Journey</h2>
